...
<div class="container">
    	<div class="page-header">
    		<h1>Detailed Balance</h1>
    	</div>
    	<div class="row">
    		<div class="col-sm-8">
    			<div class="thumbnail">
    				<img src="http://www.albertalandlord.org/images/vign_543.jpg" alt="Balance">
...
<div class="col-sm-4">
    			...
    			<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">Balance Statement</h3>
					</div>
    ...
    echo "0 results";
							...
							<tr>
								...
								if ($setChange<0) {
                                    ...
                                    echo "No credit or amount owing";
                                }
