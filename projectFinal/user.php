...
$sql="SELECT * FROM _user where AccountNumber=$AccountNumber ";
...
<div class="container">
    	...
    	<div class="row">
    		<div class="col-sm-8">
    			<div class="thumbnail">
    				<img src="http://dublinfamilydoctor.com/wp-content/uploads/2012/07/iStock_000019431247Small.jpg" alt="User">
							...
							<tr>
                                ...
                                $count=0;
									if ($res->num_rows > 0) {
                                                ...
                                                $count++;
											    echo $count.". "."Phone Number: ".$PhoneNo." <br> "; 
$count++;
                                                echo $count.". "."Lot Number:".$LotNo."<br>"; 
                                                $count++;
                                                echo $count.". "."Balance: $".$balance."<br>"; 
                                                $count++;
                                                echo $count.". "."Last Check In:".$CheckIn. "<br>";
                                                $count++;
                                                echo $count.". "."Last Checkout: ".$Checkout. "<br>";
